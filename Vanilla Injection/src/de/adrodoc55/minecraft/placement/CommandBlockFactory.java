 ...
 * {@link CommandBlockPlacer#place(List, Coordinate3I, Coordinate3I, Orientation3, CommandBlockFactory)}.
 *
...
public interface CommandBlockFactory<C extends Command, CB> {
   ...
   * @param coordinate the {@link Coordinate3I}
   * @param direction the {@link Direction3}
   * @return an instance of {@code <CB>}
   */
  CB create(int indexInChain, @Nullable C command, Coordinate3I coordinate, Direction3 direction);
}
